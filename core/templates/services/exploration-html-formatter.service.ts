...
export class ExplorationHtmlFormatterService {
  constructor(private interactionObjectFactory: InteractionObjectFactory) {}

  // Delegate to the factory method for formatting interaction
  getInteractionHtml(interaction: Interaction): string {
    return this.interactionObjectFactory.formatInteractionAsHtml(interaction);
  }
}
